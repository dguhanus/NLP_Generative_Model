...
# In[ ]:
# LSTM with no TimeDistributed in the last layer
...
h = LSTM(intermediate_dim, return_sequences=True, activation='relu',  recurrent_dropout=0.2)(x_embed)
...
decoder_mean = LSTM(NB_WORDS, return_sequences=True, recurrent_dropout=0.2)
